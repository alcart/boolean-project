...
switch(index){ 
case 1:
    for (long i = element; i < (1 << 2); i += maxCores)) {
...
case 8:
    for (long i = element; i < (1 << 21); i += maxCores)) {
...
case 9:
    for (long i = element; i < (1 << 25); i += maxCores)) {
...
case 11:
    for (long i = element; i < (1 << 30); i += maxCores)) {
...
case 13:
    for (long i = element; i < (1 << 39); i += maxCores)) {
...
case 14:
    for (long i = element; i < (1 << 45); i += maxCores)) {
...
case 15:
    for (long i = element; i < (1 << 50); i += maxCores)) {
...
case 16:
    for (long i = element; i < (1 << 60); i += maxCores)) {
...
case 17:
    for (long i = element; i < (1 << 61); i += maxCores)) {
...
case 19:
    for (long i = element; i < (1 << 62); i += maxCores)) {
...
case 21:
    for (long i = element; i < (1 << 63); i += maxCores)) {
...
case 25:
    for (long i = element; i < (1 << 8); i += maxCores)) {
...
case 26:
    for (long i = element; i < (1 << 9); i += maxCores)) {
...
case 27:
    for (long i = element; i < (1 << 12); i += maxCores)) {
...
case 28:
    for (long i = element; i < (1 << 10); i += maxCores)) {
...
case 30:
    for (long i = element; i < (1 << 16); i += maxCores)) {
...
case 31:
    for (long i = element; i < (1 << 18); i += maxCores)) {
...
case 34:
    for (long i = element; i < (1 << 24); i += maxCores)) {
...
case 35:
    for (long i = element; i < (1 << 26); i += maxCores)) {
...
case 36:
    for (long i = element; i < (1 << 28); i += maxCores)) {
...
case 37:
    for (long i = element; i < (1 << 29); i += maxCores)) {
...
case 38:
    for (long i = element; i < (1 << 27); i += maxCores)) {
...
case 40:
    for (long i = element; i < (1 << 31); i += maxCores)) {
...
case 41:
    for (long i = element; i < (1 << 34); i += maxCores)) {
...
case 42:
    for (long i = element; i < (1 << 35); i += maxCores)) {
...
case 43:
    for (long i = element; i < (1 << 36); i += maxCores)) {
...
case 44:
    for (long i = element; i < (1 << 40); i += maxCores)) {
...
case 46:
    for (long i = element; i < (1 << 42); i += maxCores)) {
...
case 47:
    for (long i = element; i < (1 << 43); i += maxCores)) {
...
case 49:
    for (long i = element; i < (1 << 41); i += maxCores)) {
...
case 51:
    for (long i = element; i < (1 << 51); i += maxCores)) {
...
case 52:
    for (long i = element; i < (1 << 52); i += maxCores)) {
...
case 53:
    for (long i = element; i < (1 << 54); i += maxCores)) {
...
case 54:
    for (long i = element; i < (1 << 47); i += maxCores)) {
...
case 55:
    for (long i = element; i < (1 << 55); i += maxCores)) {
...
case 57:
    for (long i = element; i < (1 << 57); i += maxCores)) {
...
case 58:
    for (long i = element; i < (1 << 58); i += maxCores)) {
